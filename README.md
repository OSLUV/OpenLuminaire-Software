...
To change the firmware splash image, simply drop 3 image files into the /rp directory. They must be named 'image_default.png', 'image_basic.png', and 'image_dimmable.png' and may be of any dimensions.
